...
Обычный гость может:
  ...
  + Зарегистрироваться 
  + Залогиниться
![Просмотреть товар](https://i.imgur.com/XBc6Jfz.png)
![Залогиниться](https://i.imgur.com/MhbZpSS.png)
![Зарегистрироваться](https://i.imgur.com/zRQqJAU.png)
...
Администратор может:
  ...
  + Добавлять новые услуги, редактировать и удалять их
  + Добавлять рабочие дни, редактировать и удалять их
