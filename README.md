...
Обычный гость может:
  ...
  + Зарегистрироваться 
  + Залогиниться
![Просмотреть товар](https://i.imgur.com/eZWxsbp.png)
...
Администратор может:
  ...
  + Просматривать, добавлять услуги, редактировать и удалять их (Проверка на дубликаты)
  + Просматривать, сортировать, добавлять рабочие дни, редактировать и удалять их (Проверка на дубликаты)
